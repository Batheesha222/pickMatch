    ...
    <section id="profile">
        <div class="form-container">
            <form method="post">
                ...
                <input type="submit" name="editName" value="Edit Name" class="edit-btn">
                <p>Email : <?php echo $email; ?></p>
                <input type="submit" name="editEmail" value="Edit Email" class="edit-btn">
                <p>Password : <?php echo "XXXXXXXXXXXX"; ?></p>
                <input type="submit" name="changePassword" value="Change Password" class="edit-btn">
